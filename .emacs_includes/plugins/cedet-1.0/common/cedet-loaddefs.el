...
Test compatability functions." t nil)
...
Run the CEDET unit test in BATCH mode." nil nil)
...
Insert the contents of WIDGET inserting PREFIX before each element." nil nil)
...
Data debug STUFF in a buffer named *NAME DDebug*." nil nil)

(autoload (quote data-debug-edebug-expr) "data-debug" "\
Dump out the contents of some expression EXPR in edebug with ddebug." t nil)
