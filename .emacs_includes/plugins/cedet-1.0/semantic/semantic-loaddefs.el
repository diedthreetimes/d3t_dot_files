...
to provide a large number of non-cached analysis for filtering symbols." nil nil)
...
Used as options when completing." nil nil)
...
(define-widget (quote tag-edit) (quote group) "Abstractly modify a Semantic Tag." :tag "Tag" :format "%v" :convert-widget (quote widget-types-convert-widget) :value-create (quote semantic-tag-widget-value-create) :value-get (quote semantic-tag-widget-value-get) :value-delete (quote widget-children-value-delete) :validate (quote widget-children-validate) :match (quote semantic-tag-widget-match) :clone-object-children nil)

(autoload (quote semantic-tag-widget-match) "semantic-custom" "\
Match infor for WIDGET against VALUE." nil nil)

(autoload (quote semantic-tag-widget-value-create) "semantic-custom" "\
Create the value of WIDGET." nil nil)

(autoload (quote semantic-tag-widget-value-get) "semantic-custom" "\
Get the value out of WIDGET." nil nil)

(define-widget (quote tag) (quote tag-edit) "A Semantic Tag." :format "%{%t%}:\n%v" :value-to-internal (quote semantic-tag-widget-to-internal) :value-to-external (quote semantic-tag-widget-to-external) :close-object-children t)

(autoload (quote semantic-tag-widget-to-internal) "semantic-custom" "\
For WIDGET, convert VALUE to a safe representation." nil nil)

(autoload (quote semantic-tag-widget-to-external) "semantic-custom" "\
For WIDGET, convert VALUE from the abstract value." nil nil)
...
If TAG is not provided, then the tag under point is used." t nil)
...
Unhighlight TAG, restoring its previous face." nil nil)
...
Flush functions from `semantic-decorate-pending-decoration-hook'." nil nil)
...
just the lexical token and not the string." nil nil)
...
Test the output parser against some collected strings." t nil)

(autoload (quote semantic-gcc-test-output-parser-this-machine) "semantic-gcc" "\
Test the output parser against the machine currently running Emacs." t nil)
...
Display a list of all variants for the symbol under POINT." t nil)
...
See `semantic-ia-fast-jump' for details on how it works.
 This command is meant to be bound to a mouse event." t nil)
...
If you just want to add new languages, use
   `semantic-load-enable-primary-exuberent-ctags-support'." t nil)
...
Search occurs in the current buffer between START and END." nil nil)
...
tag that contains point, and return that." t nil)
...
Depends on the SRecode Field editing API." t nil)
...
CScope supported hierarchy." nil nil)
...
Uses the `default-directory' to derive results." t nil)
...
Parse INPUT string and output the result of computation." t nil)

(autoload (quote wisent-calc-utest) "wisent-calc" "\
Test the wisent calculator." t nil)
